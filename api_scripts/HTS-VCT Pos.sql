...
SELECT "MMpDjTelEHg" data_element,
...
-- KP Section
UNION SELECT "jiF26FVPvtL" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "nfQYC947cRj" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
