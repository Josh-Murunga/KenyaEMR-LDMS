...
SELECT "YUqWNqv4X37" data_element,
...
-- KP Section
UNION SELECT "vNlWoipDPC3" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "omCy8JwN0K4" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
