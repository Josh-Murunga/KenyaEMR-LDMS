...
SELECT "LjWtktufxaF" data_element,
...
AND hts.`final_test_result` = 'Negative'
AND hts.voided =0 
...
-- KP Section
UNION SELECT "rWpjsKI0Csd" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "kFzTiCsv2g2" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
