...
SELECT "pQb8DfxpnHE" data_element,
...
-- KP Section
UNION SELECT "TTMe3Pnp8xt" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "AQyQVRTPwYL" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
