...
SELECT "BcKVyeBmnSA" data_element,
...
-- KP Section
UNION SELECT "urccIsWSoJj" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "JZzWrN1nBsg" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
