...
SELECT "GGHSZJTnGsp" data_element,
	IF(tx.age_group = '1-4yrs' AND tx.gender = 'F',   'Ba7q1fmRuK8',
	IF(tx.age_group = '1-4yrs' AND tx.gender = 'M',   'o1ggPXtBx5j',
	IF(tx.age_group = '5-9yrs' AND tx.gender = 'F',   'SN80Wz53y5H',
	IF(tx.age_group = '5-9yrs' AND tx.gender = 'M',   'U4aWyqFWPad',
	IF(tx.age_group = '10-14yrs' AND tx.gender = 'F', 'TZhK0k8Hy49',
	IF(tx.age_group = '10-14yrs' AND tx.gender = 'M', 'iJtwo4Fc4qM',
...
WHERE hts.hts_entry_point IN (163096,159939,159938) 
...
-- KP Section
UNION SELECT "ylNzeqjgZXP" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "gymaHondBVq" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
