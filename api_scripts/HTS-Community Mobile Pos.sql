...
SELECT "Iy6xgJiNfwx" data_element,
...
-- KP Section
UNION SELECT "O8EAX9Btg1V" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "VaHZfAVvIJs" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
