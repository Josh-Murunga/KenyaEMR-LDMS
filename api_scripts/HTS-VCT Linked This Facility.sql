...
SELECT "Y4YxFsGWKof" data_element,
...
-- KP Section
UNION SELECT "PAPpj1iA5Ci" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "t4jjMdqcz8l" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
