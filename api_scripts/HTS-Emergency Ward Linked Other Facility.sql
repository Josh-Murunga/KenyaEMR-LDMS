...
SELECT "Ewdu6TBLaP8" data_element,
...
WHERE hts.hts_entry_point IN (160522) 
...
-- KP Section
UNION SELECT "cxdjeGv3P0R" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "Qok1Itep2IV" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
