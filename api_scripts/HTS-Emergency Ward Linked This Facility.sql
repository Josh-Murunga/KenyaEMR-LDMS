...
SELECT "dit22L6Mrzk" data_element,
...
-- KP Section
UNION SELECT "GzgyIxujkoh" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "Dwo0qh9UO8Z" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
