...
SELECT "OqL5iUAhXue" data_element,
...
-- KP Section
UNION SELECT "L3Xx95OlxKF" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "p2jyUsOfdTX" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
