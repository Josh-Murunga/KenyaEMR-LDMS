...
SELECT "Ke1dVcgn52Z" data_element,
...
-- KP Section
UNION SELECT "qfIEsk9x8hZ" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "KKJFf3UaFnK" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
