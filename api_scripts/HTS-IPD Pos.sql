...
SELECT "iGEpCRYEj91" data_element,
...
WHERE hts.hts_entry_point IN (5485) 
...
-- KP Section
UNION SELECT "QBASruodkbg" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "MLTkASFpTIV" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
