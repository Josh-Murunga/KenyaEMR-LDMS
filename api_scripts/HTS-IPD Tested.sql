...
SELECT "AvRg3RM8tUA" data_element,
...
-- KP Section
UNION SELECT "OAp3fkiGgHj" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "z2ASc2tOkkf" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
