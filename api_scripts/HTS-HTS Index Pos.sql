...
SELECT "s44GfhxTWKn" data_element,
...
-- KP Section
UNION SELECT "hZnQAZT2IBy" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "LQU8gAVWfRV" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
