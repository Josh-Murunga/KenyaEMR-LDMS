...
SELECT "hIaed8PyMIp" data_element,
...
-- KP Section
UNION SELECT "VPFWuX2XPgk" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "YR7Un5F1c0A" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
