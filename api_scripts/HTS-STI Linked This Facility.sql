...
SELECT "kSTUZv3dQjS" data_element,
...
-- KP Section
UNION SELECT "aZHWJkzT6DY" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "FfncE5KuW81" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
