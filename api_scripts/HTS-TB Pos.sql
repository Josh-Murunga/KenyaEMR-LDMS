...
SELECT "bgE9BPGMiZi" data_element,
...
-- KP Section
UNION SELECT "K3Sdboywz6U" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "Rqsdj2ZUpH5" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
