...
SELECT "hzeR9J28OJ3" data_element,
...
-- KP Section
UNION SELECT "GfGWWYg1Q8k" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "AVJurVTRHzB" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
