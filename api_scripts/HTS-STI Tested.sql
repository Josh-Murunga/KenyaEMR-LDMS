...
SELECT "Y9GQntcHHZy" data_element,
...
-- KP Section
UNION SELECT "eSkyXZurTZ0" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "nZWnDsBXqXm" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
