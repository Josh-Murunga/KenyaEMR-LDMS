...
SELECT "n9yIJmHwnI4" data_element,
...
WHERE hts.hts_entry_point IN (160546) 
...
-- KP Section
UNION SELECT "iUFBCw4FlFN" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "dsIEAPamWzk" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
