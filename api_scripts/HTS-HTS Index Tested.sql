...
SELECT "eDz8JCMdwlA" data_element,
...
-- KP Section
UNION SELECT "MfqFhAMjevr" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "XwVHBYOyGcU" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
