...
SELECT "GIZ0kzMLsxy" data_element,
...
WHERE hts.hts_entry_point IN (5622,160542) 
...
-- KP Section
UNION SELECT "zgLDBbw5ho0" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "zRCrU5lDEzo" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
