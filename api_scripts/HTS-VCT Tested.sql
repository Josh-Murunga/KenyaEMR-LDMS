...
SELECT "Ji4A467pGlj" data_element,
...
-- KP Section
UNION SELECT "cHRuT7XhqmW" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "e1NSYlRwegG" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
