...
SELECT "Fn94lRFUuN6" data_element,
...
-- KP Section
UNION SELECT "RGvvrh2gRyo" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "qn53EAqIih3" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
