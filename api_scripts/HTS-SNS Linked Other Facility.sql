...
SELECT "X0uV7z4rV2r" data_element,
...
-- KP Section
UNION SELECT "n1DCTsufzu7" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "mZMgAXMbksp" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
