...
SELECT "dj2X0GWSnn8" data_element,
...
-- KP Section
UNION SELECT "XMOK2FCyja4" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "Yih7NFHIqdf" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
