...
SELECT "fkRKUl6uCLU" data_element,
...
-- KP Section
UNION SELECT "wNs55yx1zBN" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "p0SRgVTjzYc" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
