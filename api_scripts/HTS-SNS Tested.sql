...
SELECT "uTvZC2NKfYY" data_element,
...
-- KP Section
UNION SELECT "ngitGLfAL2f" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "lZY5iHx0up1" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
