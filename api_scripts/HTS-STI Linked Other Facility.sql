...
SELECT "u0Ahkhir4fU" data_element,
...
-- KP Section
UNION SELECT "tI3Ams5uy3C" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "TNTgOt3XPt4" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
