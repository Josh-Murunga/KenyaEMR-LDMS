...
SELECT "Nm2jbj15hyA" data_element,
...
-- KP Section
UNION SELECT "mZUsf1E4Q3U" data_element, (CASE t.key_population_type
...
-- PWID Section
UNION SELECT "vmoirOWSXm7" data_element, IF(t.key_population_type = 'People who inject drugs' AND t.Gender = 'F','UXCXK9rZDyA',
